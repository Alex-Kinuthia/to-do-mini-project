...
// asserts that we can successfully create instances of this class
  @Test
...
//enables users to differentiate lists of tasks
  @Test
...
//is a static variable used to list all of a user's category objects so they may select which list they'd like to view.
  @Test
